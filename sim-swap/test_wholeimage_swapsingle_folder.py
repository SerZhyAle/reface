...
if __name__ == '__main__':
    ...
    path_f = os.path.join(opt.pic_b_path,'*.jpg')
    ...
    with torch.no_grad():
        ...
        if opt.use_mask:
            ...
            net =None
#
        for frame_index in list(glob.glob(path_f)):
            ...
            try:
                ...
                if detect_results is not None:
                    ...
                    now = datetime.now()
                    newname =opt.prefix + now.strftime("%Y%m%d%H%M%S%f")+'.jpg'            
